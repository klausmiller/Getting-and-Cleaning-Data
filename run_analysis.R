...
<html lang="en" class=" is-copy-enabled">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <link rel="web-socket" href="wss://live.github.com/_sockets/ODAyNDUzMDo5ZTQ1M2Q5ZjVlMzAyZDllY2E3MDkwM2VkOTZmY2I0ZToyNjgzYjFlOTczN2Y1NDU0NjM3NGQ4YTFmMTMyMTI4OGU1NjlkYjAxYjEyNjI5YTBmZTIxNzI4NmRkMDUxMGEz--a2bdc2896ce77ae25d87312beff4205ce64e5fea">
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="6D5B23FC:3629:5E8FA09:560817AC" name="octolytics-dimension-request_id" /><meta content="8024530" name="octolytics-actor-id" /><meta content="klausmiller" name="octolytics-actor-login" /><meta content="3fb836f5a6a4a513e94e0bdb0284b1fa651536ecec5831b20f630488471b6a5f" name="octolytics-actor-hash" />
    ...
    <meta name="user-login" content="klausmiller">

      <link rel="mask-icon" href="https://assets-cdn.github.com/pinned-octocat.svg" color="#4078c0">
      <link rel="icon" type="image/x-icon" href="https://assets-cdn.github.com/favicon.ico">

    <!-- </textarea> --><!-- '"` --><meta content="authenticity_token" name="csrf-param" />
<meta content="r3fQzD0Mea3kPIHV6nqYNH+0kCdU4f0o3Vvvw7ulyXmsygRV7MXRTdlV4VUaX5JH66ybJyQEjFhxJeSgHk23IQ==" name="csrf-token" />
    <meta content="09c428e4454db40fa0363be04e55e2159ed1b44e" name="form-nonce" />
...
<ul class="header-nav user-nav right" id="user-links">
  <li class="header-nav-item">
      <span class="js-socket-channel js-updatable-content"
        data-channel="notification-changed:klausmiller"
...
<a class="dropdown-item" href="/new" data-ga-click="Header, create new repository">
  ...
  <li class="header-nav-item dropdown js-menu-container">
    <a class="header-nav-link name tooltipped tooltipped-s js-menu-target" href="/klausmiller"
       aria-label="View profile and more"
       data-ga-click="Header, show menu, icon:avatar">
      <img alt="@klausmiller" class="avatar" height="20" src="https://avatars2.githubusercontent.com/u/8024530?v=3&amp;s=40" width="20" />
      <span class="dropdown-caret"></span>
    </a>
    ...
    <div class="dropdown-menu-content js-menu-content">
      <div class="dropdown-menu  dropdown-menu-sw">
        <div class=" dropdown-header header-nav-current-user css-truncate">
            Signed in as <strong class="css-truncate-target">klausmiller</strong>
        ...
        <div class="dropdown-divider"></div>
          ...
          <a class="dropdown-item" href="/klausmiller" data-ga-click="Header, go to profile, text:your profile">
            Your profile
          </a>
        ...
        <a class="dropdown-item" href="https://help.github.com" data-ga-click="Header, go to help, text:help">
          ...
          <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/logout" class="logout-form" data-form-nonce="09c428e4454db40fa0363be04e55e2159ed1b44e" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="Cu1OTTM/3S0hBKKw+MuMcuMg1/hY36CTrx/Q8OxwSodLCHGQHtIUQCLJxYBS4ixVC8DJuXOjuwROncD3eGJDXA==" /></div>
...
<ul class="pagehead-actions">
  ...
  <li>
      <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-form-nonce="09c428e4454db40fa0363be04e55e2159ed1b44e" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="8AN4ogp0RnYLV11ekW4v2Y9p5F1TE8NP6/0woP503RHjJg85WcAgpT6RJCGHeO2UrnAGEnqFPzlOgWHeXOA91g==" /></div>    <input id="repository_id" name="repository_id" type="hidden" value="32694259" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    ...
    <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/bgentry/coursera-getting-and-cleaning-data-project/unstar" class="js-toggler-form starred js-unstar-button" data-form-nonce="09c428e4454db40fa0363be04e55e2159ed1b44e" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="lon1nebowlug2ag4DX88iaot8mIKQwHN8G0RyUQaQhL5i+ZvU5GNWHe4mjgzBQfd6LyMMNvGqhmSngFwBR31XA==" /></div>
      <button
    ...
    <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/bgentry/coursera-getting-and-cleaning-data-project/star" class="js-toggler-form unstarred js-star-button" data-form-nonce="09c428e4454db40fa0363be04e55e2159ed1b44e" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="8aBSHHF4pnlSlajX/NtwRNrBJgamBASkycpX7n8pJbak6T8O7rNLb0WxLSHjt6pJBnFYGjxt9Ar3kqxxuyFhmQ==" /></div>
      <button
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/bgentry/coursera-getting-and-cleaning-data-project/fork" class="btn-with-count" data-form-nonce="09c428e4454db40fa0363be04e55e2159ed1b44e" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="/olVb64iZai1Dub5K7qIMjQEt7Volj4Br5YQKAzsFnBNZPCNNWtXSMpq/nV8vOw/NigOCwqFRksW0fFFZNVx+g==" /></div>
            <button
                type="submit"
...
<div class="clone-options">You can clone with
  <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=http&amp;protocol_type=clone" class="inline-form js-clone-selector-form is-enabled" data-form-nonce="09c428e4454db40fa0363be04e55e2159ed1b44e" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="O52/npG1qPsLoXyy1Dql4Vj84JMt/3vt4hKOVDVIVzDfHEkI98PXzGPslI3HWpqfG16zsKQN3oO6LIGnfS0euQ==" /></div><button class="btn-link js-clone-selector" data-protocol="http" type="submit">HTTPS</button></form>, <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=ssh&amp;protocol_type=clone" class="inline-form js-clone-selector-form is-enabled" data-form-nonce="09c428e4454db40fa0363be04e55e2159ed1b44e" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="L30NbWQoLN7sOU7rSxZFjliUPsUDoACR9zB4VEumCXwTTkR0S3UIlG7++ATGFN6UbzDUfUa+3G3DAN7mxEUL+A==" /></div><button class="btn-link js-clone-selector" data-protocol="ssh" type="submit">SSH</button></form>, or <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=subversion&amp;protocol_type=clone" class="inline-form js-clone-selector-form is-enabled" data-form-nonce="09c428e4454db40fa0363be04e55e2159ed1b44e" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="yM1HXMFUVQHF1kxoSpRl7wZ0yNP/PRKT9B3qprhLJJeEQ3wzpUrzffRhhR0J8LI/k+0LCPV9Lc119ww7/PTc+Q==" /></div><button class="btn-link js-clone-selector" data-protocol="subversion" type="submit">Subversion</button></form>.
  ...
  <div class="file-actions">
    ...
    <div class="btn-group">
      ...
      <a class="octicon-btn tooltipped tooltipped-nw"
         href="github-windows://openRepo/https://github.com/bgentry/coursera-getting-and-cleaning-data-project?branch=master&amp;filepath=run_analysis.R"
         aria-label="Open this file in GitHub Desktop"
         data-ga-click="Repository, open with desktop, type:windows">
          <span class="octicon octicon-device-desktop"></span>
      </a>

        <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/bgentry/coursera-getting-and-cleaning-data-project/edit/master/run_analysis.R" class="inline-form js-update-url-with-hash" data-form-nonce="09c428e4454db40fa0363be04e55e2159ed1b44e" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="TTUQfo8iHT+eBlitlz0AKJj+wSgSbTu4qLZ0QsZahbyai6cSLsxmVzJlputZHI5048KwzF7sF+WvvNTRgawx/A==" /></div>
          <button class="octicon-btn tooltipped tooltipped-nw" type="submit"
            aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
            <span class="octicon octicon-pencil"></span>
          </button>
</form>        <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/bgentry/coursera-getting-and-cleaning-data-project/delete/master/run_analysis.R" class="inline-form" data-form-nonce="09c428e4454db40fa0363be04e55e2159ed1b44e" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="Y+WvfB853lyx7ELsuLfmF0JMuBechlLj1ofaUNXFrUj43nilPLQm9nt4Jg7EHHO0q8D/2kD4WRwnuTGb056DZw==" /></div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.07689s from github-fe142-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
